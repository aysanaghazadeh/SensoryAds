...
if __name__ == '__main__':
    ...
    print('-' * 100)
    print('Evosense-LLAMA3-InternVL-336000')
    metrics = json.load(open(
        '/Users/aysanaghazadeh/experiments/results/SensoryAds/new_results/Evosense_LLM/IN_InternVL_sensation_annotations_parsed_1200_test_ALL_real_description_generation_LLAMA3_instruct_finetunedTrue_my_HierarchicalCPO_extended_annotation_LLAMA3_instruct21000.json'))
    print(len(metrics))
    get_human_score_agreement(metrics, human_annotations)
    get_kappa_agreement(metrics, human_annotations)
    get_krippendorff_agreement(metrics, human_annotations)
