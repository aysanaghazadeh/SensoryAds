...
if __name__ == '__main__':
    ...
    metrics = json.load(open('/Users/aysanaghazadeh/experiments/SensoryAds/Image_Reward.json'))
    ...
    # print((metrics['2/39922.jpg']['Moisture and Dryness'][-1] - min_val) / (max_val - min_val))
