...
if __name__ == '__main__':
    ...
    metrics = json.load(open('/Users/aysanaghazadeh/experiments/SensoryAds/IN_InternVL_train_images_total_ALL_description_generation_QWenLM_finetunedTrue_12000.json'))
