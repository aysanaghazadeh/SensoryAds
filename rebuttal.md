...
While there are only 50 images (now we also fine-tune on 100 images in new experiments), each image is paired with negative and positive sensation, which expands the data to 21000 samples that the models have been fine-tuned on.  
...
**Number of image-(positive, negative, parent of positive) pairs**
  ...
  * For each image we collect the (positive - negative) sensation pair for each two sensations:
...
* We only fine-tune on real ads while we also compute the agreement of our metric with humans on generated ads which are very different as shown in Fig. 6 and 9 in the updated paper. Our metrics achieves high agreement of 0.68 with human annotators on generated images(30% improvement compared to baseline with the highest agreement, VQAScore).
* We also only fine-tune the model on descriptions generated by InternVL; however, we also evaluate on descriptions generated by QwenVL further supporting generalization to different styles of descriptions. Our metrics with QwenVL description has substantial agreement of 0.80 (45% improvement compared to baseline with the highest agreement, VQAScore) showing the generalization of our metric to different styles of descriptions.
...
We have added the topic and sensation diversity in appendix - A.3 - Fig. 11. The figure represent the distribution of images over 10 most frequent topics and 5 sensations. 
...
For the train we use 50 images (now we also fine-tune on 100 images in new experiments), and use the annotations to use each image multiple times. 
...
* Each image is annotated with a maximum of 9 sensations that the image evokes. 
* Each sensation is associated with a score on the quality of the sensation evocation. 
* For each image we collect the (positive, negative) sensation pairs for each two sensations: 
...
Two results in Table 2 supports generalization of our fine-tuned LLM:
* We only fine-tune on real ads while we also compute the agreement of our metric with humans on generated ads which are very different as shown in Fig. 6 and 9 in the updated paper. Our metrics achieves high agreement of 0.68 with human annotators on generated images(30% improvement compared to baseline with the highest agreement, VQAScore).
* We also only fine-tune the model on descriptions generated by InternVL; however, we also evaluate on descriptions generated by QwenVL further supporting generalization to different styles of descriptions. Our metrics with QwenVL description has substantial agreement of 0.80 (45% improvement compared to baseline with the highest agreement, VQAScore) showing the generalization of our metric to different styles of descriptions.
...
* **Marketing Publications**
    ...
    We are not discovering the relation between the sensation and persuasion, instead we are building on prior marketing and psychology publications to explore the machine learning techniques in this area. As also referenced in the paper, Sensory Advertisement is a well-studied concept in marketing research. Since this has been previously extensively studied we rely on and trust the outcome of previous marketing and psychology works. The claim is already supported by the following papers, and books from marketing research including the user study.
...
We have added the text-image alignment (AIM from [1]) column to table 2 in the paper. 
...
* **Marketing Publications**
    ...
    Lindstrom in his book [2] cited over 1400 times, shows the relation between the sensory appeal and brand effectiveness, and shows that the brands should use senses based on their products. They further suggest that the sensory perception in marketing results in consumers’ loyalty to the brand. 
    
    [3] cited over 130 times, designs two studies on relation between sensory advertisements and attitude toward the brand. They show sensory ads increase positive attitude toward the brand (increasing the effectiveness of advertisement) and the reason for why sensory advertisement works is that it triggers the self-referencing, i.e.  audience imagining using the product.

    [4] cited over 380 times, discusses how Sensory Marketing influences the effectiveness of the advertisement highlighting improvement in the effectiveness of ads by evoking mental simulation. 

    [5] cited over 130 times, reviewed the existing works in sensory images and their effects on consumer behavior, and their findings suggest that sensory advertisements increase the mental imagery in consumers and mental imagery can enhance the ad persuasion. 

    [2] [Lindstrom, Martin. "Brand sense: How to build powerful brands through touch, taste, smell, sight and sound." Strategic Direction 22.2 (2006).](https://www.emerald.com/sd/article/doi/10.1108/sd.2006.05622bae.001/353448/Brand-Sense-How-to-Build-Powerful-Brands-Through)

    [3] [Yoon, Sung-Joon, and Ji Eun Park. "Do sensory ad appeals influence brand attitude?." Journal of Business Research65.11 (2012): 1534-1542.](https://www.sciencedirect.com/science/article/pii/S0148296311000701)

    [4] [Krishna, Aradhna, Luca Cian, and Tatiana Sokolova. "The power of sensory marketing in advertising." Current Opinion in Psychology 10 (2016): 142-147.](https://www.sciencedirect.com/science/article/abs/pii/S2352250X16000099)

    [5] [Elder, Ryan S., and Aradhna Krishna. "A review of sensory imagery for consumer psychology." Journal of Consumer Psychology 32.2 (2022): 293-315.](https://myscp.onlinelibrary.wiley.com/doi/full/10.1002/jcpy.1242)
