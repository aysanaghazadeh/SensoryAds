...
def get_training_args(args):
    training_args = CPOConfig(
        output_dir=args.model_path+f'/my_HierarchicalCPO_data_annotation_{args.LLM}',
...
def train(args):
    ...
    if args.model_checkpoint is not None:
        ...
        trainer.train(resume_from_checkpoint=args.model_path+f'/my_HierarchicalCPO_data_annotation_{args.LLM}/checkpoint-{args.model_checkpoint}')
    else:
